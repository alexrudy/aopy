...
def _generate_filter(shape,r0,du,L0=0,nsh=0):
    ...
    :param r0: :math:`r_0` fried parameter for the screen, in meters
    :param du: :math:`du` pixel size, in meters
    :param L0: :math:`L_0` outer scale for the screen, in meters
