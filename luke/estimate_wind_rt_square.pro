...
function estimate_wind_rt,pCurr,pPrev,wind_prior,pApa,maxit
...
;	DeltaI_y = fltarr(m)
	...
	bestguess_x_shift = interpolate(bestguess_x,ix_cen);,cubic = -0.5)
	bestguess_y_shift = interpolate(bestguess_y,iy_cen);,cubic = -0.5)
