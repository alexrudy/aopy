...
;	set up shift vectors to use for interpolation
	...
	if cubic_interp then begin
		shift_points[*,*,0] = interpolate(*pPrev,ix_cen,iy_min,/grid,cubic = -0.5)
		shift_points[*,*,1] = interpolate(*pPrev,ix_cen,iy_pls,/grid,cubic = -0.5)
	endif else begin
	;create shifted images using linear interpolation
		shift_points[*,*,0] = interpolate(*pPrev,ix_cen,iy_min,/grid)
		shift_points[*,*,1] = interpolate(*pPrev,ix_cen,iy_pls,/grid)
	endelse
